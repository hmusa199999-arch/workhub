    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="bg-gray-900 rounded-2xl border border-gray-700 p-10 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-100 mb-2">تم نشر الوظيفة!</h2>
    ...
    <div className="min-h-screen bg-gray-950 py-8 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-100">نشر إعلان وظيفة</h1>
        </div>
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-700 p-6 md:p-8">
          ...
          {step === 1 && (
            <div className="space-y-5">
              <h2 className="text-lg font-bold text-gray-100 mb-6">المعلومات الأساسية</h2>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">المسمى الوظيفي *</label>
                <input type="text" value={form.title} onChange={e => set('title', e.target.value)} placeholder="مثال: مطور برمجيات أول" className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">القطاع *</label>
                  <select value={form.sector} onChange={e => set('sector', e.target.value)} className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm bg-gray-900">
                ...
                <div>
                  ...
                  <select value={form.type} onChange={e => set('type', e.target.value)} className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm bg-gray-900">
                ...
                <div>
                  ...
                  <select value={form.experienceLevel} onChange={e => set('experienceLevel', e.target.value)} className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm bg-gray-900">
                ...
                <div>
                  ...
                  <input type="text" value={form.location} onChange={e => set('location', e.target.value)} placeholder="دبي، الإمارات العربية المتحدة" className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">الراتب الشهري (AED) - اختياري</label>
                <div className="grid grid-cols-2 gap-3">
                  <input type="number" value={form.salaryMin} onChange={e => set('salaryMin', e.target.value)} placeholder="الحد الأدنى" className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm" dir="ltr" />
                  <input type="number" value={form.salaryMax} onChange={e => set('salaryMax', e.target.value)} placeholder="الحد الأقصى" className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm" dir="ltr" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">آخر موعد للتقديم - اختياري</label>
                <input type="date" value={form.deadline} onChange={e => set('deadline', e.target.value)} className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm" dir="ltr" />
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <h2 className="text-lg font-bold text-gray-100 mb-6">التفاصيل والمتطلبات</h2>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">وصف الوظيفة *</label>
                <textarea rows={5} value={form.description} onChange={e => set('description', e.target.value)} placeholder="اكتب وصفاً مفصلاً للوظيفة وبيئة العمل..." className="w-full px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm resize-none" />
              </div>
                ...
                <div className="space-y-2">
                  {form.requirements.map((req, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <input type="text" value={req} onChange={e => updateListItem('requirements', i, e.target.value)} placeholder={`متطلب ${i + 1}`} className="flex-1 px-4 py-2.5 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm" />
              ...
              <div>
                ...
                <div className="space-y-2">
                  {form.responsibilities.map((resp, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <input type="text" value={resp} onChange={e => updateListItem('responsibilities', i, e.target.value)} placeholder={`مهمة ${i + 1}`} className="flex-1 px-4 py-2.5 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm" />
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm"
                  />
          ...
          {step === 3 && (
            <div className="space-y-5">
              <h2 className="text-lg font-bold text-gray-100 mb-6">مراجعة إعلان الوظيفة</h2>
              <div className="p-5 bg-gray-50 rounded-2xl border border-gray-700 space-y-4">
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-xl font-bold text-gray-100">{form.title || '—'}</h3>
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-100">
            {step > 1 ? (
              <button onClick={() => setStep(s => s - 1)} className="px-6 py-3 border border-gray-700 text-gray-700 font-semibold rounded-xl hover:bg-gray-800 transition-colors">
                السابق
              </button>
            ) : <div />}
